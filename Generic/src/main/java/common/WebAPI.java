...
public class WebAPI {
    ...
    public static String sauceLabs_userName = "abunabi";
    public static String sauceLabs_accessKey = "54c30912-4a23-46aa-9801-a78e1b87189d";
...
// Helper Method
    ...
    public String getCurrentPageUrl(String s) {
    ...
    public static final String loginBtnLocator="//*[@id=\"unav-l1-signin\"]";
    public static final String inputUserLocator="//input[@id='ods-input-0']";
    public static final String inputPasswordLocator="//input[@id='ods-input-1']";
    public static final String loginSubmitButtonLocator="//button[contains(text(),'Sign In')]";

    @FindBy(how = How.XPATH, using =loginBtnLocator) public WebElement login_btn;
    @FindBy(how = How.XPATH, using =inputUserLocator) public WebElement input_user;
    @FindBy(how = How.XPATH, using =inputPasswordLocator) public WebElement input_pwd;
    @FindBy(how = How.XPATH, using =loginSubmitButtonLocator) public WebElement login_submit;

    public void login1(WebElement login_btn, String tableName, WebElement input_user, WebElement input_pwd, WebElement login_submit) throws Exception {
        login_btn.click();
        ...
        int myID = rn.nextInt(3) + 1;
        System.out.println(myID);
        ConnectToSqlDB.connectToSqlDatabase();
        ConnectToSqlDB.statement = ConnectToSqlDB.connect.createStatement();
        ConnectToSqlDB.resultSet = ConnectToSqlDB.statement.executeQuery("select * from  " + tableName + " where id=" + myID + "");

        while (ConnectToSqlDB.resultSet.next()) {
            String email = ConnectToSqlDB.resultSet.getString("email");
            input_user.sendKeys(email);
            sleepFor(2);
            String pwd = ConnectToSqlDB.resultSet.getString("password");
